                                  ...
                                  const mbedtls_mpi *m, const mbedtls_ecp_point *P )
{
    ...
    uint32_t scalar[CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS] = { 0 };
    uint32_t inPointX[CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS] = { 0 };
    uint32_t inPointY[CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS] = { 0 };
    uint32_t outPointX[CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS] = { 0 };
    uint32_t outPointY[CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS] = { 0 };
    uint32_t tmpBuff[CRYS_PKA_ECPKI_SCALAR_MUL_BUFF_MAX_LENGTH_IN_WORDS] = { 0 };
    ...
    CRYSError_t error = PkaEcWrstScalarMult( pDomain, scalar, orderSizeInWords,
                                             inPointX, inPointY, outPointX, outPointY,
                                             ( uint32_t * )&tmpBuff );
                                       ...
                                       mbedtls_mpi *d, mbedtls_ecp_point *Q )
{
    ...
    CRYS_ECPKI_Domain_t domain = *CRYS_ECPKI_GetEcDomain( grp_id );
